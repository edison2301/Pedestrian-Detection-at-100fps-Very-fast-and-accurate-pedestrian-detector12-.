...
if(HOSTED_AT_VISICS GREATER -1)
  ...
  set(CUDA_SDK_ROOT_DIR  /users/visics/mmathias/no_backup/code/reference/cuda-5.5_toolkit)
  #set(CUDA_SDK_ROOT_DIR  /usr/local/cuda-5.5/)
  set(CUDA_NVCC_FLAGS ${CUDA_NVCC_FLAGS} --compiler-options -D__USE_XOPEN2K8 --pre-include /users/visics/mmathias/devel/biclop/undef_atomics_int128.h) # black magic required on Visics machines
...
elseif(${HOSTNAME} STREQUAL  "sammy")
  ...
  set(local_CUDA_LIB_DIR "/usr/local/cuda/lib")
  set(cuda_LIBS "cuda")
...
elseif(${HOSTNAME} STREQUAL "tester-System-Product-Name")

 message(STATUS "Using Toyota Tester System optimisation options")
  ...
  set(local_CUDA_CUT_INCLUDE_DIRS "/home/tester/NVIDIA_GPU_Computing_SDK/C/common/inc")
  set(local_CUDA_CUT_LIBRARY_DIRS "/home/tester/NVIDIA_GPU_Computing_SDK/C/lib")
  set(local_CUDA_LIB_DIR "/usr/local/cuda/lib")
  set(cuda_LIBS "")
  set(cutil_LIB "cutil_i386")
...
#elseif(${HOSTNAME} STREQUAL "yellow.ant") 
elseif(HOSTED_AT_TOYOTA_USA GREATER -1)

message(STATUS "Using Toyota USA optimisation options")
  ...
  # GTX 580 has compute capability 2.0
  set(CUDA_NVCC_FLAGS ${CUDA_NVCC_FLAGS} -arch=sm_20)

  set(local_CUDA_CUT_INCLUDE_DIRS "/opt/cuda_sdk/C/common/inc/")
  set(local_CUDA_CUT_LIBRARY_DIRS "/opt/cuda_sdk/C/lib")
  set(local_CUDA_LIB_DIR "/usr/local/cuda/lib64")
  set(cuda_LIBS "")
  set(cutil_LIB "")
...
elseif(${HOSTNAME} STREQUAL  "ruegen")
  message(STATUS "Using ruegen optimisation options")
  
  # add local compiled opencv trunk in the pkg-config paths
  #set(PKG_CONFIG_PATH ${PKG_CONFIG_PATH}:/home/mfritz/local/lib/pkgconfig)
  set(PKG_CONFIG_PATH /home/mfritz/local/lib/pkgconfig)

  set(opencv_INCLUDE_DIRS "/home/mfritz/local/opencv_2.4.3/include/")
  ...
  include_directories(
    /home/mfritz/software/protobuf-readonly
...
elseif(${HOSTNAME} STREQUAL  "wks-12-23")
  message(STATUS "Using wks-12-23 optimisation options")
