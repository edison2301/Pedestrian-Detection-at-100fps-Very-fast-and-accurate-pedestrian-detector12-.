...
_DETECTORMODEL_OCCLUSIONTYPES = descriptor.EnumDescriptor(
  name='OcclusionTypes',
...
_INTEGRALCHANNELSTUMPSET = descriptor.Descriptor(
...
_DETECTORMODELSBUNDLE = descriptor.Descriptor(
...
class IntegralChannelStumpSet(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
...
class DetectorModelsBundle(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
