#ifndef BICLOP_INTEGRALCHANNELSDETECTORMODELSBUNDLE_HPP
#define BICLOP_INTEGRALCHANNELSDETECTORMODELSBUNDLE_HPP
...
#endif // BICLOP_INTEGRALCHANNELSDETECTORMODELSBUNDLE_HPP
